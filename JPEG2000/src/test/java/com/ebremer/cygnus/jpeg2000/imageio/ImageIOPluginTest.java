...
class ImageIOPluginTest {
    ...
    void resolutionReductionReadParam() throws Exception {
        ...
        com.ebremer.cygnus.jpeg2000.decoder.Jpeg2000Decoder dec =
                new com.ebremer.cygnus.jpeg2000.decoder.Jpeg2000Decoder();
        dec.open(j2k);
        com.ebremer.cygnus.jpeg2000.decoder.DecodedImage expect = dec.decode(1);
