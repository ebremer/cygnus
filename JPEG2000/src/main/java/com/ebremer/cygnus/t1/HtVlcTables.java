...
/**
 * VLC codeword tables for the HTJ2K cleanup pass (ITU-T T.814 Annex C,
 * Tables C.19/C.20), indexed by (context << 7) | (7 bits of VLC data).
 * Each entry packs: bits 0-2 codeword length, bit 3 u_off, bits 4-7
 * significance pattern rho, bits 8-11 EMB e_1, bits 12-15 EMB e_k.
 * Table data as distributed with OpenJPEG (BSD-2, ht_dec by Aous Naman).
 */
final class HtVlcTables {

    private HtVlcTables() {
    }

    static final int[] VLC_TBL0 = {
