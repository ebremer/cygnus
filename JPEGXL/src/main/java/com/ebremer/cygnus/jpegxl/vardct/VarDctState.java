...
public final class VarDctState {
    ...
    public void reconstruct(float[][] framePlanes) throws IOException {
        ...
        com.ebremer.cygnus.jpegxl.decoder.JxlDecoder.parallelFor(fh.numGroups, group -> {
            int[][] coeffs = groupCoeffs[group];
            if (coeffs == null) {
                return;
            }
    ...
    public float[] epfInverseSigma(com.ebremer.cygnus.jpegxl.codestream.RestorationFilter rf) {
