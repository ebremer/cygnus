package com.ebremer.jpegxl.container;
...
public final class Container {
     ...
     */
    public static java.util.List<com.ebremer.jpegxl.io.CodestreamSource.Segment> scanSegments(
            javax.imageio.stream.ImageInputStream in) throws IOException {
        java.util.List<com.ebremer.jpegxl.io.CodestreamSource.Segment> segments =
        ...
        if (got >= 2 && (head[0] & 0xff) == 0xff && (head[1] & 0xff) == 0x0a) {
            segments.add(new com.ebremer.jpegxl.io.CodestreamSource.Segment(0, 0, length));
            return segments;
        }
        ...
        while (off + 8 <= length) {
            ...
            if (first) {
                ...
                segments.add(new com.ebremer.jpegxl.io.CodestreamSource.Segment(
        ...
        while (off + 8 <= data.length) {
            ...
            if (first) {
                ...
                if (inner == (wanted & 0xFFFFFFFFL)) {
                    byte[] plain = com.ebremer.jpegxl.brotli.Brotli.decode(
