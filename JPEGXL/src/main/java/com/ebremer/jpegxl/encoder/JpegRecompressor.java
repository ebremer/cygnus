...
import com.ebremer.jpegxl.jpeg.JpegData;
import com.ebremer.jpegxl.jpeg.JpegParser;
 ...
 * {@link com.ebremer.jpegxl.jpeg.JpegReconstructor} (or {@code djxl}) can
...
public final class JpegRecompressor {
    ...
    private ImageMetadata buildMetadata() {
        ...
        com.ebremer.jpegxl.codestream.ColourEncoding colour =
                new com.ebremer.jpegxl.codestream.ColourEncoding();
        if (grey) {
            colour.allDefault = false;
            colour.colourSpace = com.ebremer.jpegxl.codestream.ColourEncoding.CS_GREY;
        }
